...
// CHANGE - Fran: Renamed this for conflict reasons.
static const float FLOOR1_fromdB_LOOKUP_RE[256]={
...
static int floor1_inverse2(vorbis_block *vb,vorbis_look_floor *in,void *memo,
  ...
  if(memo){
    ...
    for(j=hx;j<n;j++)out[j]*=FLOOR1_fromdB_LOOKUP_RE[ly]; /* be certain */
    return(1);
  }
